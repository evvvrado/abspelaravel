...
<body class="home" style="overflow:hidden;">
    <div id="backdrop" style="background:#E5E5E5;">
        <div class="logo"><img src="{{ asset('site/img/logoABS.png') }}" width="115" height="115" alt="Logomarca Associação Brasileira de Sommeliers - Brasil"></div>
    </div>
    <header class="header home">
        <section class="logos">
            <a class="ancora" href="/" title="Home"><img src="{{ asset('site/img/logoABS.png') }}" width="115" height="115" alt="Logomarca Associação Brasileira de Sommeliers - Brasil"></a>
            <a class="asi" target="_blank" rel="noopener" title="Navegar para ASI" href="https://www.asi.info/"><img src="{{ asset('site//img/logoASI.png') }}" width="115" height="115"
                    alt="Logomarca ASI"></a>
            ...
            <nav class="sobe">
                <div class="menuLateral">
                    ...
                    <a href="#" title="Ajuda"><img width="23" height="23" src="{{ asset('site//img/ico_ajuda.svg') }}" alt="Ajuda"></a>
                    <a href="https://www.youtube.com/channel/UCjm6Wo9sSzg3L88oFicZvYg" title="Youtube" target="_blank" rel="nofollow noopener"><img width="27" height="27"
                            src="{{ asset('site//img/ico_youtube.svg') }}" alt="Youtube"></a>
                    <a href="https://www.instagram.com/abs.brasil/" title="Instagram" target="_blank" rel="nofollow noopener"><img width="27" height="27" src="{{ asset('site//img/ico_insta.svg') }}"
                            alt="Instagram"></a>
                    <a href="https://www.facebook.com/ABS-Brasil-105852698310241" title="Facebook" target="_blank" rel="nofollow noopener"><img width="27" height="27"
                            src="{{ asset('site//img/ico_face.svg') }}" alt="Facebook"></a>
                    <a class="whatsapp" href="https://api.whatsapp.com/send?phone=55DEFINIR" title="WhatsApp" target="_blank" rel="nofollow noopener"><img width="27" height="27"
    ...
    <main class="main">
        <section id="agenda">
            <div class="maxSec">
                <img class="taca" src="{{ asset('site/img/tacas.svg') }}" width="439" height="199" alt="Taças desenhadas em uma linha">
                <div class="intro">
        ...
        <section id="blogHome" class="slider fundo">
            <div class="base">
                <div>
                        ...
                        <div class="gradeBlog sliderCorpo">
                            <div class="sliderItem">
                                <a href="/noticias/projeto-digital">
                                    <img width="370" height="191" src="{{ asset('site/img/_blog1.jpg') }}" alt="Ilustra Blog 1">
                                    <p class="info">
                                        <img width="18" height="19" src="{{ asset('site/img/ico_calendar.svg') }}" alt="Icone calendário">3.Jun 2021
                                    </p>
                                </a>
                            ...
                            <div class="sliderItem">
                                <a href="/noticias/danio-braga">
                                    <img width="370" height="191" src="{{ asset('site/img/_blog2.jpg') }}" alt="Ilustra Blog 2">
                                    <p class="info">
                                        <img width="18" height="19" src="{{ asset('site/img/ico_calendar.svg') }}" alt="Icone calendário">2.Jun 2021
                                    </p>
                                </a>
                                <a class="tag" href="/noticias/abs-brasil">ABS Brasil</a>
                            ...
                            <div class="sliderItem magro">
                                <a href="/noticias/vinagre">
                                    <img width="370" height="191" src="{{ asset('site/img/_blog3.jpg') }}" alt="Ilustra Blog 3">
                                    <p class="info">
                                        <img width="18" height="19" src="{{ asset('site/img/ico_calendar.svg') }}" alt="Icone calendário">3.Jun 2021
                                    </p>
                                </a>
                            ...
                            <div class="sliderItem magro">
                                <a href="/noticias/asi">
                                    <img width="370" height="191" src="{{ asset('site/img/_blog4.jpg') }}" alt="Ilustra Blog 4">
                                    <p class="info">
                                        <img width="18" height="19" src="{{ asset('site/img/ico_calendar.svg') }}" alt="Icone calendário">30.Mai 2021
                                    </p>
                                </a>
                    ...
                    <div class="sliderBtn">
                        <button title="Anterior"><img width="32" height="32" src="{{ asset('site/img/ico_setaEsq.svg') }}" alt="Seta esquerda"></button>
                        <button title="Próximo" class="proximo"><img width="32" height="32" src="{{ asset('site/img/ico_setaDir.svg') }}" alt="Seta direita"></button>
                    </div>
                </div>
                <div>
        </section>
        <section id="numeros">
            <img class="banner" src="{{ asset('site/img/banner_numeros.jpg') }}" alt="Queijos e vinho" width="405" height="467">
            <div class="intro">
        ...
        <section id="onde" class="fundo">
            <div class="base">
                <img class="postal" src="{{ asset('site/img/banner_onde.jpg') }}" alt="Postal" width="505" height="647">
                <div class="cidades">
        ...
        <section id="apoio">
            <nav>
                <a target="_blank" rel="noopener" title="Navegar para apoio 1" href="#"><img src="{{ asset('site/img/apoio4.jpg') }}" width="117" height="117" alt="Logomarca Apoio 4"></a>
                <a target="_blank" rel="noopener" title="Navegar para apoio 2" href="#"><img src="{{ asset('site/img/apoio2.jpg') }}" width="117" height="117" alt="Logomarca Apoio 2"></a>
                <a target="_blank" rel="noopener" title="Navegar para apoio 3" href="#"><img src="{{ asset('site/img/apoio3.jpg') }}" width="117" height="117" alt="Logomarca Apoio 3"></a>
                <a target="_blank" rel="noopener" title="Navegar para apoio 4" href="#"><img src="{{ asset('site/img/apoio4.jpg') }}" width="117" height="117" alt="Logomarca Apoio 4"></a>
            </nav>
        </section>
    </main>
    <footer class="footer">
        <section id="banner">
            <div>
                <div class="logo">
                    <a title="Home" href="/"><img src="{{ asset('site/img/logoABS.png') }}" width="115" height="115" alt="Logomarca '.SIS_NOME.'"></a>
                    <a target="_blank" rel="noopener" title="Navegar para ASI" href="https://www.asi.info/"><img src="{{ asset('site/img/logoASI.png') }}" width="115" height="115"
                            alt="Logomarca ASI"></a>
                </div>
                <div class="social">
                    <a class="ifl1linkIcone" target="_blank" rel="noopener" title="Facebook" href="{{$configuracoes->facebook}}"><img src="{{ asset('site/img/ico_face.svg') }}" width="27" height="27"
                            alt="Ícone Facebook"></a>
                    <a class="ifl1linkIcone" target="_blank" rel="noopener" title="Instagram" href="{{$configuracoes->instagram}}"><img src="{{ asset('site/img/ico_insta.svg') }}" width="27"
                            height="27" alt="Ícone Instagram"></a>
                    <a class="ifl1linkIcone" target="_blank" rel="noopener" title="Youtube" href="{{$configuracoes->youtube}}"><img src="{{ asset('site/img/ico_youtube.svg') }}" width="27" height="27"
                            alt="Ícone Youtube"></a>
                </div>
            </div>
            <div>
                ...
                <div class="btn">
                    <a href="/cadastro">Assinar <img width="47" height="8" src="{{asset('site/img/ico_setaLonga.svg')}}" alt="Seta Longa"></a>
                </div>
            </div>
        </section>
        <hr>
        <section id="links">
            ...
            <nav>
                ...
                <div>
                    <a target="_blank" rel="noopener" title="Ver mapa" href="'.CONTATO_GMAPS.'"><img src="{{ asset('site/img/ico_user.svg') }}" width="20" height="22"
                    ...
                    --><a target="_blank" rel="noopener" title="Email" href="mailto:{{$configuracoes->email}}"><img src="{{ asset('site/img/ico_envelope.svg') }}" width="25" height="25"
        ...
        <section id="copy">
            ...
            <div>
                <p>Desenvolvido por <a href="https://7seventrends.com" title="Clique para visitar o site da 7 Seven Trends" target="_blank" rel="nofollow noopener"><img width="68" height="16"
