        ...
        <div class="container-fav showin">
            <div class="content">
                ...
                <div class="_cursos">
                    ...
                    $cont = 0;
                    @endphp
                    @foreach ($turmas->where('modalidade', 0) as $turma)
                    @php
                ...
                <div class="_eventos">
                    ...
                    $cont = 0;
                    @endphp
                    @foreach ($turmas->where('modalidade', 1) as $turma)
                    @php
                    $parcelas = $turma->parcelas;
                    $valor_parcela = $turma->preco / $parcelas;
                    $reais_parcelas = floor($valor_parcela);
                        ...
                        <div class="curso-item">
                            ...
                            <div class="curso-content">
                                ...
                                <div class="row">
                                    <div class="price">
                                        {{ $turma->parcelas }}x<span class="lowsized">R$</span>@if($reais_parcelas > 1000){{ number_format($reais_parcelas, 0, ",", ".")
                                        }}@else{{$reais_parcelas}}@endif<span class="lowsized">,@if (number_format($centavos_parcelas) == 0)00
                                            @else
