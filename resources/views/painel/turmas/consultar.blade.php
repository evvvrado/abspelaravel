                            ...
                            <td class="text-center">
                                <div class="dropdown mt-4 mt-sm-0">
                                    ...
                                    <div class="dropdown-menu" style="margin: 0px;">
                                        ...
                                        @else
                                        <a href="{{ route('painel.turma.ativo', ['turma' => $turma]) }}" class="dropdown-item" role="button"><i class="fas fa-eye"></i>
                                            Ativar</a>
                                        @endif

                                        @if ($turma->aberto)
                                        <a href="{{ route('painel.turma.inscricao', ['turma' => $turma]) }}" class="dropdown-item" role="button"><i class="fas fa-lock"></i>
                                            Fechar Inscrições</a>
                                        @else
                                        ...
                                        @endif
                                        <a href="{{ route('painel.turma.conteudo', ['turma' => $turma]) }}" id="" class="dropdown-item" role="button"><i class="fas fa-list pr-3"></i>
                                            Conteudo</a>
                                    </div>
                                </div>
                            </td>
