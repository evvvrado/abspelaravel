...
<head>
    ...
    <meta charset="utf-8" />
    <title>ABS-PE - Sistema Administrativo</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Painel de controle da ABS-PE" name="description" />
                        ...
                        <div class="w-100">
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5">
                                    <a href="/" class="md-block auth-logo">
                                ...
                                <div class="mt-4 mt-md-5 text-center text-white">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> <img class="ml-2 mt-n1" src="{{asset('/site/imagens/footer-seven.png')}}" alt=""></p>
                                </div>
                            </div>
