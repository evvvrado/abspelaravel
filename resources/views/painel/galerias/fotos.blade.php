...
@section('titulo')
    Fotos da Galeria - {{$galeria->nome}}
@endsection

@section('botoes')
    <a name="" id="" href="{{route('painel.galerias')}}" class="btn btn-primary">Voltar</a>
@endsection
            ...
            <div class="card-body">
                <div class="zoom-gallery d-flex flex-wrap">
                    @foreach($galeria->fotos as $foto)
                        <a href="{{asset($foto->imagem)}}" title="" fid="{{$foto->id}}"><img src="{{asset($foto->imagem)}}" alt="" width="275"></a>
                    @endforeach
